+function (t) {
    ...
    i.VERSION = "3.3.5", i.TRANSITION_DURATION = 600, i.DEFAULTS = {
        ...
        return this.$items = t.parent().children(".item"), this.$items.en(t || this.$active)
    ...
    o.VERSION = "3.3.5", o.TRANSITION_DURATION = 350,
        o.DEFAULTS = {toggle: !0}, o.prototype.dimension = function () {
